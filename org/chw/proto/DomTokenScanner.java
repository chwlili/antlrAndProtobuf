...
public class DomTokenScanner implements ITokenScanner
{
	...
	private static IToken Name = new Token(new TextAttribute(new Color(Display.getCurrent(), new RGB(0, 0xFF, 0xFF))));
	private static IToken Index = new Token(new TextAttribute(new Color(Display.getCurrent(), new RGB(0xFF, 0xFF, 0))));	
	...
	public IToken nextToken()
	{
		...
		switch(token.getType())
		{
			...
			case ExprLexer.Index	:	return Index;
